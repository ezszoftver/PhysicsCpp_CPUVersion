...
void CreateCube(glm::vec3 v3Position, glm::quat quatOrientation, glm::vec3 v3HalfSize, float fMass)
{
	...
	if (fMass > 0.0f) 
	{
		float a = v3HalfSize.x * 2.0f;
		float b = v3HalfSize.y * 2.0f;
		float c = v3HalfSize.z * 2.0f;
		float m = fMass;
...
bool Init() 
{
	...
	CreateCube(glm::vec3(0, 1.0f, 0), glm::quat(glm::radians(glm::vec3(0.0f, 0.0f, 0.0f))), glm::vec3(0.5f, 0.5f, 0.5f), 1.0f);
